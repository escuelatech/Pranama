          ...
          <nav id="menu">
            ...
            <ul>
              ...
              <li>
               ...
               <li>
                <router-link @click="handleRouterLinkClick" :to="{ name: 'RegisteredUsers' }">REGISTERED USERS</router-link>
              </li>
                <li>
                <router-link @click="handleRouterLinkClick" :to="{ name: 'AddAgentPage' }">ADD AN AGENT</router-link>
              <li>
                <router-link @click="handleRouterLinkClick" :to="{ name: 'AddCarPage' }">Vehicle Registration</router-link>
              </li>
              <li>
                <router-link @click="handleRouterLinkClick" :to="{ name: 'AgentSearchPage' }">AGENT SEARCH</router-link>
              </li>
