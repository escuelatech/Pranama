...
const agentMessage = `<header class="major"><h4>Thank you for getting in toutch with us!!</h4></header><h4>You will receive an email as part of registration,one of our team member will getting back to you for further proceedings.</h4><br><h6>If you haven't received the email, do the following:<ul><li>Make sure the provided email address is correct</li><li>Check Promotions and Spam Folders</li><!-- <li>Resend confirmation email</li> --></ul>If none of the above helps, please contact us at <a href="/contactus">pranamaindia@gmail.com</a></h6>`
