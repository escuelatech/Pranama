    ...
    <div>
          ...
          <form @submit.prevent="submitEditProfile" v-show="!EditProfileSuccessful" >
            <div class="row gtr-uniform">
              ...
              <div class="col-6 col-12-xsmall">
                <input type="text" name="firstName" value placeholder="First Name" v-model="firstName" autocomplete="off" required />
                <span class="errNotific" v-if="msge.firstName">{{msge.firstName}}</span>
              </div>

              <div class="col-6 col-12-xsmall">
                <input type="text" name="lastName" value placeholder="Last Name" v-model="lastName" autocomplete="off" required />
