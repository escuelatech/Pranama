    ...
    <div id="wrapper">
      ...
      <div id="main">
        <div class="inner">
          ...
          <!-- Content -->
          <section>
					<h2 id="content">Mental Health </h2>
					<p>
						Elder people have psychological problems, sleep problems, depression etc, because of loneliness,
						Fear of death, Fear of un-certainty etc.

						We have a professional team with Psychiatrists and Psychologists to manage such conditions.</p>
					<div class="row">
						...
						<div class="col-4 col-12-medium">
							...
							<p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing gravida odio porttitor sem non mi
                                ...
                                <a href="#" class="image"><img src="@/assets/images/mental health 1.jpg" alt="" /></a>
						</div>
						<div class="col-4 col-12-medium">
							...
							<p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing gravida odio porttitor sem non mi
								integer non faucibus ornare mi ut ante amet placerat aliquet. Volutpat eu sed ante
								lacinia sapien lorem accumsan varius montes viverra nibh in adipiscing blandit.</p>
                                 <a href="#" class="image"><img src="@/assets/images/mental health 2.jpg" alt="" /></a>
						</div>
						<div class="col-4 col-12-medium">
